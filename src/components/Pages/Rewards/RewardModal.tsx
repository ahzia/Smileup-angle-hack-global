...
export default function RewardModal({ isOpen, onClose, reward }: RewardModalProps) {
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            className="max-w-md w-3/4 h-3/5 p-6 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-lg shadow-lg text-white relative"
        >
            <div className="border-4 border-dashed border-[#FFF] h-full p-4 flex flex-col justify-between">
                {/* Reward Image */}
                ...
                {/* Reward Title */}
                <h2 className="text-2xl font-bold mt-4">{reward.name}</h2>
